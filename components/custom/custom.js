      ...
      if (app.globalSystemInfo && !app.globalSystemInfo.ios) {
        ...
        try {
          ...
          if (systemInfo.platform === 'android') {
            ...
            gap = ios ? 5.5 : 7.5 // 5.5开发工具中ios手机 7.5开发工具中android和其他手机
          } else {
            gap = 4;
            width = 88;
          }
        ...
        if (!systemInfo.statusBarHeight) {
          ...
          systemInfo.navBarExtendHeight = ios ? 4 : 0; //下方扩展4像素高度 防止下方边距太小
        }
